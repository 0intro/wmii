...
static void
init_col(Area * a, Client * clients)
{
    Client *n, *c = clients;
...
static void
attach_frame(Area * a, Column * col, Frame * new)
{
    Acme *acme = a->aux;
...
static void
detach_col(Area * a, Client * c, Bool unmap)
{
    Acme *acme = a->aux;
    Frame *f = c->frame;
    Cell *cell = f->aux;
